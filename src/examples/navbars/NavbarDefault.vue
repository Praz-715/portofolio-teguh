      ...
      <!-- <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation"> -->
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item"><RouterLink class="nav-link text-dark font-weight-bolder" to="#" v-scroll-to="'#home'"> Home </RouterLink></li>
            <li class="nav-item">
              <RouterLink class="nav-link text-dark font-weight-bolder" to="#" v-scroll-to="'#tentang'">About Us</RouterLink></li>
            <li class="nav-item">
              <RouterLink class="nav-link text-dark font-weight-bolder" to="#" v-scroll-to="'#contactUs'">Contact Us</RouterLink></li>
          </ul>
